...
const BottomNavbar = () => {
  ...
  return (
    <nav className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-white/10 text-white rounded-full px-4 py-2 shadow-lg z-50 backdrop-blur-md border border-white/20 w-[95%] max-w-md">
